<template>
  <header class="bg-white px-4 sm:px-6 py-3 sm:py-4">
        ...
        <div class="relative">
          ...
          >
            <div class="py-1">
              ...
              <button
                @click="goToProfile"
                class="flex items-center w-full px-3 sm:px-4 py-2 text-xs sm:text-sm text-gray-700 hover:bg-gray-100 transition-colors duration-200"
              >
                <svg class="mr-2 sm:mr-3 h-3 w-3 sm:h-4 sm:w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="border-t border-gray-100 mt-1">
                <button
                  @click="logout"
                  class="flex items-center w-full px-3 sm:px-4 py-2 text-xs sm:text-sm text-red-600 hover:bg-red-50 transition-colors duration-200"
                >
                  <svg class="mr-2 sm:mr-3 h-3 w-3 sm:h-4 sm:w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
